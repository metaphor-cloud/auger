...
from reviewrig.tracker.server import build


def parse(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="reviewrig-tracker",
    ...
    parser.add_argument(
        "--home",
        default=None,
        help="The reviewrig home. The default is REVIEWRIG_HOME, or ~/.reviewrig.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if repository is None:
        ...
        print(
            "reviewrig-tracker: this directory is not in a git repository. "
